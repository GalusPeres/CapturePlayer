...
export function HdrControls() {
  ...
  return <div className="flex items-center gap-3">
    ...
    <InfoHint info={<>
      Requires Direct capture under View → Video mode. The capture card and driver must deliver real 10-bit HDR, with card tone mapping off. Windows and Linux use HDR10/PQ; macOS requires tagged PQ or HLG buffers. An HDR-capable display is needed to see HDR highlights. HDMI passthrough alone is insufficient.
